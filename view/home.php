                                ...
                                <div class="row align-items-center position-relative">
                                    <div class="col-12 col-md-6">
                                        <div class="hero-two-slide-content">
                                            <div class="hero-two-slide-text-img"><img src="view/assets/images/slider/text-light.webp" width="427" height="232" alt="Image"></div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="hero-two-slide-thumb">
                                            <img src="view/assets/images/slider/slider3.webp" width="690" height="690" alt="Image">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide hero-two-slide-item">
                            <div class="container">
                                <div class="row align-items-center position-relative">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="hero-two-slide-thumb">
                                            <img src="view/assets/images/slider/slider4.webp" width="690" height="690" alt="Image">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-4">
                            ...
                            <a href="product.html" class="product-banner-item">
                                <img src="view/assets/images/shop/banner/4.webp" width="370" height="370" alt="Image-HasTech">
                            </a>
                        ...
                        <div class="col-sm-6 col-lg-4 mt-sm-0 mt-6">
                            <!--== Start Product Category Item ==-->
                            <a href="product.html" class="product-banner-item">
                                <img src="view/assets/images/shop/banner/5.webp" width="370" height="370" alt="Image-HasTech">
                            </a>
                            <!--== End Product Category Item ==-->
                        </div>
                        <div class="col-sm-6 col-lg-4 mt-lg-0 mt-6">
                            <!--== Start Product Category Item ==-->
                            <a href="product.html" class="product-banner-item">
                                <img src="view/assets/images/shop/banner/6.webp" width="370" height="370" alt="Image-HasTech">
                            </a>
                            <!--== End Product Category Item ==-->
                        </div>
                    </div>
                ...
                <div class="container">
                    ...
                    <div class="row mb-n9">
                        <div class="col-sm-6 col-lg-4 mb-8">
                            ...
                            <div class="post-item">
                                <a href="blog-details.html" class="thumb">
                                    <img src="view/assets/images/blog/1.webp" width="370" height="320" alt="Image-HasTech">
                                </a>
                                <div class="content">
                        ...
                        <div class="col-sm-6 col-lg-4 mb-8">
                            ...
                            <div class="post-item">
                                <a href="blog-details.html" class="thumb">
                                    <img src="view/assets/images/blog/2.webp" width="370" height="320" alt="Image-HasTech">
                                </a>
                                <div class="content">
                        ...
                        <div class="col-sm-6 col-lg-4 mb-8">
                            ...
                            <div class="post-item">
                                <a href="blog-details.html" class="thumb">
                                    <img src="view/assets/images/blog/3.webp" width="370" height="320" alt="Image-HasTech">
                                </a>
                                <div class="content">
