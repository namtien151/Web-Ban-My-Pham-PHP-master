                    ...
                    <div class="row align-items-center">
                        <div class="col-md-7 col-lg-7 col-xl-5">
                            <div class="page-header-content">
                                <div class="title-img"><img src="view/assets/images/photos/about-title.webp" alt="Image"></div>
                        ...
                        <div class="col-md-5 col-lg-5 col-xl-7">
                            <div class="page-header-thumb">
                                <img src="view/assets/images/photos/about1.webp" width="570" height="669" alt="Image">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row mb-n6">
                        <div class="col-sm-6 col-lg-4 mb-6">
                            ...
                            <div class="funfact-item">
                                <div class="icon">
                                    <img src="view/assets/images/icons/funfact1.webp" width="110" height="110" alt="Icon">
                                </div>
                        ...
                        <div class="col-sm-6 col-lg-4 mb-6">
                            ...
                            <div class="funfact-item">
                                <div class="icon">
                                    <img src="view/assets/images/icons/funfact2.webp" width="110" height="110" alt="Icon">
                                </div>
                        ...
                        <div class="col-sm-6 col-lg-4 mb-6">
                            ...
                            <div class="funfact-item">
                                <div class="icon">
                                    <img src="view/assets/images/icons/funfact3.webp" width="110" height="110" alt="Icon">
                                </div>
                    ...
                    <div class="swiper brand-logo-slider-container">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide brand-logo-item">
                                ...
                                <img src="view/assets/images/brand-logo/1.webp" width="155" height="110" alt="Image-HasTech">
                                <!--== End Brand Logo Item ==-->
                            </div>
                            <div class="swiper-slide brand-logo-item">
                                <!--== Start Brand Logo Item ==-->
                                <img src="view/assets/images/brand-logo/2.webp" width="241" height="110" alt="Image-HasTech">
                                <!--== End Brand Logo Item ==-->
                            </div>
                            <div class="swiper-slide brand-logo-item">
                                <!--== Start Brand Logo Item ==-->
                                <img src="view/assets/images/brand-logo/3.webp" width="147" height="110" alt="Image-HasTech">
                                <!--== End Brand Logo Item ==-->
                            </div>
                            <div class="swiper-slide brand-logo-item">
                                <!--== Start Brand Logo Item ==-->
                                <img src="view/assets/images/brand-logo/4.webp" width="196" height="110" alt="Image-HasTech">
                                <!--== End Brand Logo Item ==-->
                            </div>
                        </div>
                    </div>
            ...
            <section class="section-space pt-0 mb-n1">
                <div class="container">
                    <div class="about-thumb">
                        <img src="view/assets/images/photos/about2.webp" alt="Image">
                    </div>
                    ...
                    <div class="row mb-n9">
                        <div class="col-md-6 col-lg-4 mb-8">
                            ...
                            <div class="feature-item">
                                <h5 class="title"><img class="icon" src="view/assets/images/icons/feature1.webp" width="60" height="60" alt="Icon"> Support Team</h5>
                        ...
                        <div class="col-md-6 col-lg-4 mb-8">
                            <!--== Start Feature Item ==-->
                            <div class="feature-item">
                                <h5 class="title"><img class="icon" src="view/assets/images/icons/feature2.webp" width="60" height="60" alt="Icon"> Certification</h5>
                                <p class="desc">Lorem ipsum dolor amet, consectetur adipiscing. Ac tortor enim metus, turpis.</p>
                            </div>
                            <!--== End Feature Item ==-->
                        </div>
                        <div class="col-md-6 col-lg-4 mb-8">
                            <!--== Start Feature Item ==-->
                            <div class="feature-item">
                                <h5 class="title"><img class="icon" src="view/assets/images/icons/feature3.webp" width="60" height="60" alt="Icon"> Natural Products</h5>
                                <p class="desc">Lorem ipsum dolor amet, consectetur adipiscing. Ac tortor enim metus, turpis.</p>
                            </div>
                            <!--== End Feature Item ==-->
                        </div>
