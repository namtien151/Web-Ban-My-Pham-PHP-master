                ...
                <div class="row align-items-center">
                    <div class="col-5 col-sm-6 col-lg-3">
                        <div class="header-logo">
                            <a href="index.html">
                                <img class="logo-main" src="view/assets/images/logo.webp" width="95" height="68" alt="Logo" />
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-6 d-none d-lg-block">
                        <div class="header-navigation">
                            <ul class="main-nav justify-content-start">
                                ...
                                <li><a href="index.php?act=about-us">about</a></li>
                                <li class="has-submenu position-static"><a href="index.php?act=danhmucsp">shop</a>
                    ...
                    <div class="col-7 col-sm-6 col-lg-3">
                        <div class="header-action justify-content-end">
                            ...
                            if (isset($_SESSION['user'])) {
                                echo '<a class="header-action-btn" href="index.php?act=my-account">';
                            } else {
                                echo '<a class="header-action-btn" href="index.php?act=dangkydangnhap">';
                            }
                            ?>
