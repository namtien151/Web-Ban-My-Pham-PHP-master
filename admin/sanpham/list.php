...
<div class="row"> 
      ...
      <div class="row">
        <div class="row_nb10 fomdsloai">
          ...
          <table>
            ...
            foreach ($listsanpham as $sanpham) {
             ...
             <td>'.$hinh.'</td>
             <td>'.$GiaSP.'</td>  
             <td><a href="'.$suasp.'"><input  class="sua" type="button" value="Sửa"></a><a  href="'.$xoasp.'"><input class="xoa" type="button" value="Xóa"></a> </td>
           </tr>';
          }
            ?>
          </table>
        ...
        <div >
          ...
          <a href="index.php?act=addsp"><input class='button-12' type="button" value="Nhập thêm"></a>
